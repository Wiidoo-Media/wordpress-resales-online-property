...
function p_Baths() {
document.getElementById("saved_baths_cmd").value = document.getElementById("p_Baths").value;
fileter_list();  
}
function p_Min() {
...
if (window.attachEvent) {window.attachEvent('onload', at_the_end_fu);}
else if (window.addEventListener) {window.addEventListener('load', at_the_end_fu, false);}
else {document.addEventListener('load', at_the_end_fu, false);}

if (window.attachEvent) {window.attachEvent('onload', fileter_list);}
else if (window.addEventListener) {window.addEventListener('load', fileter_list, false);}
else {document.addEventListener('load', fileter_list, false);}

if (window.attachEvent) {window.attachEvent('onload', show_locs);}
else if (window.addEventListener) {window.addEventListener('load', show_locs, false);}
else {document.addEventListener('load', show_locs, false);}

if (window.attachEvent) {window.attachEvent('onload', show_ptypes);}
else if (window.addEventListener) {window.addEventListener('load', show_ptypes, false);}
else {document.addEventListener('load', show_ptypes, false);}
...
console.log("*********************************");
console.log("* Maintained by disenoideas.com *");
console.log("*********************************");
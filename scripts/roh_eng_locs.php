...
$url = "https://webapi.resales-online.com/V5/SearchLocations";
$data = array(
        "p1" => $roh_client_id,
        "p2" => $roh_api_key,
        "P_ApiId" => $P_ApiId,
...
echo '<tr class="w3-white"><td style="cursor:pointer;" onclick="select_area('.$cnt.');">
'.$match.'
<input type="hidden" id="area_but_'.$cnt.'" value="'.$match.'">
</td></tr>';
$cnt++;
}